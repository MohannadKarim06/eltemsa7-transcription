...
class FileUploader:
    ...
    def _upload_to_catbox(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"catbox.moe upload failed: {{response.text}}")
            return None
    ...
    def _upload_to_0x0st(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"0x0.st upload failed: {{response.status_code}}")
            return None
    ...
    def _upload_to_pomf(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"pomf.lain.la upload failed: {{response.text}}")
            return None
    ...
    def _upload_to_uguu(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"uguu.se upload failed: {{response.text}}")
            return None
    ...
    def _upload_to_transfersh(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"transfer.sh upload failed: {{response.status_code}}")
            return None
    ...
    def _upload_to_tmpfiles(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"tmpfiles.org upload failed: {{response.text}}")
            return None
